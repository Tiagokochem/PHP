...
if(($result_usuarios) and ($result_usuarios->rowCount() != 0)) {
    while($row_usuario = $result_usuarios->fetch(PDO::FETCH_ASSOC)) {
        ...
        $mensagem = urlencode("$nome, PARABENS! Desejamos a voce um Feliz Aniversario, com muita alegria, sucesso e saude.");

        $url_api = "https://api.iagentesms.com.br/webservices/http.php?metodo=envio&usuario=nome-usuario&senha=123456&celular=$celular&mensagem={$mensagem}";
